  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      <header className="flex justify-between items-center p-6 border-b border-gray-100 shadow-sm">
        <div className="text-3xl font-extrabold text-blue-600 tracking-tighter">OJEMI</div>
      ...
      <main className="max-w-4xl mx-auto mt-24 px-6 text-center">
        ...
        <div className="text-left mt-16 border-t border-gray-200 pt-10">
          ...
          <div className="space-y-4">
            <div className="p-5 border border-gray-100 rounded-xl hover:shadow-lg hover:border-blue-100 transition cursor-pointer bg-gray-50 hover:bg-white">
