      ...
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 border border-gray-200 shadow-sm rounded-sm">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed text-[15px]">
          <section>
            ...
            <p>"유머인"는 원활한 커뮤니티 서비스 제공과 안전한 환경 조성을 위해 아래와 같은 최소한의 정보만을 수집하고 있습니다.</p>
          ...
          <section>
            ...
            <p>"유머인"는 수집한 개인정보를 다음의 목적을 위해 활용하며 다른 용도로는 절대 사용되지 않습니다.</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <section>
            ...
            <p>"유머인"는 회원가입일로부터 서비스를 제공하는 기간 동안에 한하여 개인정보를 보유 및 이용합니다. 원칙적으로 회원 탈퇴 등 수집 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.</p>
          ...
          <section>
            ...
            <p>"유머인"는 이용자의 개인정보를 원칙적으로 외부에 제공하거나 위탁하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.</p>
          ...
          <section>
            ...
            <p>"유머인"는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다.</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
