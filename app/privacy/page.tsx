      ...
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 border border-gray-200 shadow-sm rounded-sm">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed text-[15px]">
          <section>
            ...
            <p>"유머인"은 원활한 커뮤니티 서비스 제공과 안전한 환경 조성을 위해 아래와 같은 최소한의 정보만을 수집하고 있습니다.</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong>수집항목 :</strong> 아이디(소셜 고유 식별자), 닉네임, 이메일 주소, 비밀번호(단방향 암호화, 이메일 가입자에 한함)</li>
          ...
          <section>
            ...
            <p>"유머인"은 수집한 개인정보를 다음의 목적을 위해 활용하며 다른 용도로는 절대 사용되지 않습니다.</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong>아이디, 닉네임, 이메일 주소 :</strong> 소셜 로그인(네이버/카카오/구글 등) 연동에 따른 본인식별, 중복가입 확인, 회원 관리</li>
          ...
          <section>
            ...
            <p>"유머인"은 회원가입일로부터 서비스를 제공하는 기간 동안에 한하여 개인정보를 보유 및 이용합니다. 원칙적으로 회원 탈퇴 등 수집 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.</p>
            <div className="bg-gray-100 p-4 mt-3 rounded-sm text-sm border-l-4 border-gray-400 space-y-3">
              <p>
                <strong>※ 단, 어뷰징 방지를 위한 보존 :</strong> 무분별한 단기 탈퇴 및 재가입(어뷰징)을 방지하기 위하여, 회원 탈퇴 시 <strong>7일간 해당 회원의 식별 정보를 보관하며 7일 경과 후 지체 없이 모든 개인정보를 복구 불가능한 상태로 완전 파기(익명화)</strong> 합니다.
              </p>
              <p>
                <strong>※ 예외 보존 (악성 유저 방어용) :</strong> 불량 이용자의 재가입 방지 및 명예훼손 등 권리침해 분쟁 대비를 위해 <strong>접속 IP 및 제재 이력을 탈퇴일로부터 1년간 보존</strong> 후 파기합니다. 또한, 통신비밀보호법에 따라 <strong>웹사이트 방문기록은 3개월간 보관</strong>합니다.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>"유머인"은 이용자의 개인정보를 원칙적으로 외부에 제공하거나 위탁하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.</p>
          ...
          <section>
            ...
            <ul className="list-none mt-2 space-y-1 bg-gray-50 p-4 border border-gray-200">
              <li><strong>담당자 :</strong> 유머인 최고관리자</li>
          ...
          <section>
            ...
            <p>"유머인"은 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다.</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
