  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 border border-gray-200 shadow-sm rounded-sm">
        <h1 className="text-3xl font-bold text-gray-900 mb-8 pb-4 border-b-2 border-gray-900">유머인 이용약관</h1>
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed text-[15px]">
          <section>
            ...
            <p>이 약관은 커뮤니티 '유머인'(이하 "회사"라 한다)가 제공하는 온라인 서비스(이하 "서비스"라 한다)의 이용조건, 절차, 그리고 회원과 회사 간의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.</p>
          ...
          <section>
            ...
            <p className="mt-2">② "유머인"는 회원의 공개된 게시물로 인해 사생활 침해나 명예훼손 등 권리가 침해되었다고 주장하는 제3자의 요청(신고)이 있거나, 다수 회원의 누적 신고가 발생한 경우 시스템에 의해 즉시 해당 게시물을 임시 조치(블라인드)할 수 있습니다.</p>
          ...
          <section>
            ...
            <p>① "유머인"는 회원 간 또는 회원과 제3자 상호 간에 서비스를 매개로 하여 발생한 분쟁(명예훼손, 저작권 침해 등)에 대하여 개입할 의무가 없으며 이로 인한 손해를 배상할 책임이 없습니다.</p>
            <p>② "유머인"는 온라인서비스제공자(OSP)로서 게시물에 대한 사전 검열 의무가 없으며, 회원이 등록한 게시물의 신뢰도, 정확성, 적법성에 대해 어떠한 보증도 하지 않습니다. 권리 침해 신고 접수 시 적법한 절차에 따라 즉시 삭제 및 차단 조치를 수행함으로써 운영자의 책임을 면합니다.</p>
            <p>③ 천재지변, 디도스(DDoS) 공격, 서버 호스팅 업체의 장애 등 불가항력으로 인하여 서비스를 제공할 수 없는 경우 서비스 제공에 관한 책임이 면제됩니다.</p>

            {/* 💡 [핵심 보강] 제주도까지 재판하러 가는 불상사를 막는 관할법원 지정 조항 */}
            <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">제7조 (약관의 개정 및 관할법원)</h3>
            <p>① 회사는 법률을 위배하지 않는 범위에서 본 약관을 개정할 수 있으며, 개정 시 적용일자 7일 전부터 사이트 공지사항을 통해 고지합니다.</p>
            <p>② 서비스 이용과 관련하여 회사와 회원 간에 발생한 분쟁에 관한 소송은 회사의 본점 소재지(또는 운영자 주소지)를 관할하는 법원을 전속 관할법원으로 합니다.</p>
          </section>
        </div>
      </div>
    </div>
